...
- Generated (UTC): 2026-09-22T23:47:55.206723+00:00
...
- Result: 391/392 passed (0 failed, 0 errors, 1 skipped), exit status 0
...
| `tests/qualification/test_p0_01_pins.py::test_release_source_and_native_cargo_provenance` | P0-01 | fast | passed | 0.049 |
...
| `tests/qualification/test_p0_02_sdk_security.py::test_auth_flood_bounded_with_signing_paused` | P0-02 | asyncio, sdk | passed | 1.535 |
...
| `tests/qualification/test_p0_02_sdk_security.py::test_oversized_nip44_input_rejected_with_bounded_cost` | P0-02 | asyncio, sdk | passed | 2.585 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tampered_event_fails_verification` | P0-02 | asyncio, sdk | passed | 0.001 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tested_binary_identity_recorded_into_evidence_pins` | P0-02 | asyncio, sdk | passed | 0.032 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_listener_lifecycle_and_owned_handle_cancellation` | P0-03 | asyncio, host | passed | 2.517 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_metadata_persisted_and_exactly_queryable` | P0-03 | asyncio, host | passed | 1.378 |
| `tests/qualification/test_p0_03_host_contract.py::test_no_durable_callback_delivery_across_restart` | P0-03 | asyncio, host | passed | 5.417 |
| `tests/qualification/test_p0_04_relay_ack.py::test_external_relay_smoke` | P0-04 | asyncio, protocol, skipif | skipped | 0.001 |
| `tests/qualification/test_p0_04_relay_ack.py::test_positive_negative_and_timeout_acks_classified_per_relay` | P0-04 | asyncio, protocol | passed | 10.028 |
| `tests/qualification/test_p0_04_relay_ack.py::test_targeted_send_never_reaches_unlisted_relay` | P0-04 | asyncio, protocol | passed | 0.033 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_golden_recipient_copy_unwraps_to_golden_rumor` | P0-05 | asyncio, protocol | passed | 0.015 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_golden_sender_copy_unwraps_to_golden_rumor` | P0-05 | asyncio, protocol | passed | 0.007 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_golden_wraps_are_independent_copies` | P0-05 | asyncio, protocol | passed | 0.004 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_no_plaintext_or_key_material_in_logs` | P0-05 | asyncio, protocol | passed | 0.006 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_retry_wrap_preserves_rumor_id` | P0-05 | asyncio, protocol | passed | 0.003 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_rumor_seal_pubkey_mismatch_rejected` | P0-05 | asyncio, protocol | passed | 0.002 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_seeded_generated_mutations_rejected[truncated-content]` | P0-05 | asyncio, parametrize, protocol | passed | 0.002 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_tampered_outer_content_rejected` | P0-05 | asyncio, protocol | passed | 0.002 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_tampered_outer_signature_rejected` | P0-05 | asyncio, protocol | passed | 0.004 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_tampered_seal_content_rejected` | P0-05 | asyncio, protocol | passed | 0.004 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_valid_wrap_with_undecryptable_content_rejected` | P0-05 | asyncio, protocol | passed | 0.004 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_wrap_for_other_recipient_rejected` | P0-05 | asyncio, protocol | passed | 0.003 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_wrong_outer_kind_rejected` | P0-05 | asyncio, protocol | passed | 0.004 |
...
| `tests/qualification/test_p0_06_transactions.py::test_adapter_only_transaction_rolls_back_cleanly` | P0-06 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_06_transactions.py::test_adapter_performs_in_transaction_writes_without_host_helpers` | P0-06 | asyncio, db | passed | 0.020 |
| `tests/qualification/test_p0_06_transactions.py::test_concurrent_duplicate_scoped_order_inserts_yield_one_row` | P0-06 | asyncio, db | passed | 0.016 |
| `tests/qualification/test_p0_06_transactions.py::test_dialect_selection_matches_environment` | P0-06 | db | passed | 0.000 |
| `tests/qualification/test_p0_06_transactions.py::test_duplicate_scoped_order_insert_conflicts` | P0-06 | asyncio, db | passed | 0.015 |
...
| `tests/qualification/test_p0_06_transactions.py::test_host_auto_commit_helper_splits_domain_transaction` | P0-06 | asyncio, db | passed | 0.021 |
| `tests/qualification/test_p0_06_transactions.py::test_idempotency_record_scope_conflict` | P0-06 | asyncio, db | passed | 0.012 |
| `tests/qualification/test_p0_06_transactions.py::test_last_unit_concurrency_yields_exactly_one_reservation` | P0-06 | asyncio, db | passed | 0.067 |
| `tests/qualification/test_p0_06_transactions.py::test_lost_cas_rolls_back_the_entire_transaction` | P0-06 | asyncio, db | passed | 0.031 |
| `tests/qualification/test_p0_06_transactions.py::test_order_state_machine_table_exhaustive` | P0-06 | asyncio, db | passed | 0.221 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[inventory_reservations-params0]` | P0-06 | asyncio, db, parametrize | passed | 0.025 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[inventory_reservations-params1]` | P0-06 | asyncio, db, parametrize | passed | 0.024 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[order_items-params2]` | P0-06 | asyncio, db, parametrize | passed | 0.020 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[order_items-params3]` | P0-06 | asyncio, db, parametrize | passed | 0.016 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[relay_publications-params4]` | P0-06 | asyncio, db, parametrize | passed | 0.024 |
| `tests/qualification/test_p0_06_transactions.py::test_sorted_id_locking_avoids_deadlock` | P0-06 | asyncio, db | passed | 0.394 |
| `tests/qualification/test_p0_06_transactions.py::test_task_lease_fencing_rejects_stale_writes` | P0-06 | asyncio, db | passed | 0.027 |
| `tests/qualification/test_p0_06_transactions.py::test_winning_cas_leaves_one_held_reservation` | P0-06 | asyncio, db | passed | 0.031 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_during_inflight_invoice_creation[rejected]` | P0-07 | asyncio, db, parametrize | passed | 0.018 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_awaiting_payment_then_late_settlement` | P0-07 | asyncio, db | passed | 0.028 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[success]` | P0-07 | asyncio, db, parametrize | passed | 0.017 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[unknown]` | P0-07 | asyncio, db, parametrize | passed | 0.017 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_creation_unknown_reconciliation_attaches_exactly_one` | P0-07 | asyncio, db | passed | 0.022 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_claim_respects_dependencies_and_supersede` | P0-08 | asyncio, db | passed | 0.023 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_lease_expired_mid_claim_requeues_and_reclaims` | P0-08 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_merchant_sender_copy_recovered_without_dispatch` | P0-08 | asyncio, db | passed | 0.032 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_order_msg_keeps_stable_rumor_id_across_retries` | P0-08 | asyncio, db | passed | 0.025 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_pre_reservation_crash_resume_is_idempotent` | P0-08 | asyncio, db | passed | 0.033 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_admitted_not_validated` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_attach_before_enqueue` | P0-08 | asyncio, db | passed | 0.028 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_reservation_before_invoice_call` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_between_settlement_and_callback` | P0-08 | asyncio, db | passed | 0.031 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_claimed_not_published` | P0-08 | asyncio, db | passed | 0.033 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_partially_published_retries_only_missing` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_validated_not_dispatched` | P0-08 | asyncio, db | passed | 0.022 |
...
| `tests/qualification/test_p0_09_email_persistence.py::test_equality_hashes_are_purpose_separated_and_irreversible` | P0-09 | asyncio, db | passed | 0.012 |
...
| `tests/qualification/test_p0_09_email_persistence.py::test_no_plaintext_recipients_or_tokens_in_database` | P0-09 | asyncio, db | passed | 0.025 |
| `tests/qualification/test_p0_09_email_persistence.py::test_opt_out_revokes_consent_and_cancels_queued_customer_rows` | P0-09 | asyncio, db | passed | 0.017 |
...
| `tests/qualification/test_p0_09_email_persistence.py::test_two_merchant_recipients_two_rows_delivered_independently` | P0-09 | asyncio, db | passed | 0.101 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_crash_after_smtp_acceptance_redelivers_on_resume` | P0-10 | asyncio, db | passed | 0.020 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_customer_rate_limit_waits_rather_than_delivering` | P0-10 | asyncio, db | passed | 0.056 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_exhausted_attempts_enter_failed_never_sent` | P0-10 | asyncio, db | passed | 0.044 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_logs_expose_neither_recipients_nor_bearer_links` | P0-10 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_merchant_alert_rate_limit_at_60_per_hour` | P0-10 | asyncio, db | passed | 0.188 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_only_true_enters_sent_false_retries_with_bound` | P0-10 | asyncio, db | passed | 0.026 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_raised_exception_and_recipient_rejection_surface_identically` | P0-10 | asyncio, db | passed | 0.056 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_suppressed_rows_never_touch_smtp` | P0-10 | asyncio, db | passed | 0.052 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_true_enters_sent_with_sent_at` | P0-10 | asyncio, db | passed | 0.020 |
| `tests/qualification/test_p0_11_nip89_route.py::test_foreign_merchant_naddr_rejected` | P0-11 | protocol | passed | 0.000 |
| `tests/qualification/test_p0_11_nip89_route.py::test_golden_naddr_resolves_locally` | P0-11 | protocol | passed | 0.006 |
| `tests/qualification/test_p0_11_nip89_route.py::test_golden_nip89_pair_validates` | P0-11 | protocol | passed | 0.002 |
| `tests/qualification/test_p0_11_nip89_route.py::test_hidden_and_preorder_map_to_quantity_zero` | P0-11 | protocol | passed | 0.002 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_invalid_product_variants_rejected[invalid_specs_object.json-product-specs-not-pair-array]` | P0-11 | parametrize, protocol | passed | 0.003 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_mismatched_currencies_rejected` | P0-11 | protocol | passed | 0.002 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_valid_stall_and_product_dtos` | P0-11 | protocol | passed | 0.005 |
| `tests/qualification/test_p0_11_nip89_route.py::test_wrong_kind_naddr_rejected` | P0-11 | protocol | passed | 0.000 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_approved_cookie_same_origin_path_passes` | P0-12 | asyncio, host | passed | 0.219 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cookie_only_without_origin_rejected` | P0-12 | asyncio, host | passed | 0.237 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cross_origin_cookie_mutation_rejected` | P0-12 | asyncio, host | passed | 0.219 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_id_only_login_method_refused` | P0-12 | asyncio, host | passed | 0.696 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[cockroachdb-1-False-unsupported-dialect:cockroachdb]` | P0-12 | asyncio, host, parametrize | passed | 0.000 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_sdk_client_cleanup_on_direct_task_cancel` | P0-12 | asyncio, host | passed | 0.155 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_wrong_origin_subdomain_rejected` | P0-12 | asyncio, host | passed | 0.218 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_empty_quote_rejected` | P0-13 | db | passed | 0.000 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_model_never_calls_host_cached_fiat_helper` | P0-13 | db | passed | 0.005 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_nonfinite_rate_rejected` | P0-13 | db | passed | 0.000 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_order_fx_quotes_persists_decimal_strings` | P0-13 | asyncio, db | passed | 0.027 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_order_fx_quotes_unique_per_currency` | P0-13 | asyncio, db | passed | 0.018 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_rejection_leaves_no_reservation_or_stock_or_quote_rows` | P0-13 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_stale_quote_rejected_at_conversion_edge` | P0-13 | db | passed | 0.000 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_valid_quote_then_reservation_flow` | P0-13 | asyncio, db | passed | 0.018 |
...
| `tests/qualification/test_p0_14_contract_closure.py::test_state_machines_match_spec_bidirectional` | P0-14 | protocol | passed | 0.002 |
...
| `tests/runtime/test_admin_ui.py::test_admin_js_legal_actions` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_admin_ui.py::test_admin_no_secrets` | - | asyncio, runtime | passed | 0.105 |
| `tests/runtime/test_admin_ui.py::test_admin_notifications_copy` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_admin_ui.py::test_admin_publications_copy` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_admin_ui.py::test_admin_shell_document` | - | asyncio, runtime | passed | 1.458 |
| `tests/runtime/test_admin_ui.py::test_admin_theme_editor` | - | asyncio, runtime | passed | 0.103 |
| `tests/runtime/test_admin_ui.py::test_admin_verbatim_copy` | - | asyncio, runtime | passed | 0.109 |
| `tests/runtime/test_admin_ui.py::test_admin_workspace_layout` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_buyer_ui.py::test_digital_product_hides_address_fields` | - | asyncio, runtime | passed | 0.015 |
| `tests/runtime/test_buyer_ui.py::test_order_page_shell` | - | asyncio, runtime | passed | 0.005 |
| `tests/runtime/test_buyer_ui.py::test_product_page_checkout_card` | - | asyncio, runtime | passed | 1.350 |
| `tests/runtime/test_buyer_ui.py::test_public_js_contracts` | - | asyncio, runtime | passed | 0.007 |
| `tests/runtime/test_buyer_ui.py::test_theme_emission_scoped` | - | asyncio, runtime | passed | 0.236 |
| `tests/runtime/test_catalog_api.py::test_catalog_crud` | - | asyncio, runtime | passed | 1.365 |
| `tests/runtime/test_catalog_api.py::test_collection_zero_members_no_intent` | - | asyncio, runtime | passed | 0.017 |
| `tests/runtime/test_catalog_api.py::test_delete_reference_report_and_strip` | - | asyncio, runtime | passed | 0.027 |
| `tests/runtime/test_catalog_api.py::test_draft_produces_no_intent` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_catalog_api.py::test_dry_run_deterministic` | - | asyncio, runtime | passed | 0.029 |
| `tests/runtime/test_catalog_api.py::test_membership_enqueues_collection_and_product_dep` | - | asyncio, runtime | passed | 0.025 |
| `tests/runtime/test_catalog_api.py::test_owner_scoping` | - | asyncio, runtime | passed | 0.556 |
| `tests/runtime/test_catalog_api.py::test_product_crud_and_outbox_intent` | - | asyncio, runtime | passed | 0.025 |
| `tests/runtime/test_catalog_api.py::test_product_delete_enqueues_tombstone` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_catalog_api.py::test_product_validation_bounds` | - | asyncio, runtime | passed | 0.105 |
| `tests/runtime/test_catalog_api.py::test_published_at_preserved_across_edits` | - | asyncio, runtime | passed | 0.039 |
| `tests/runtime/test_catalog_api.py::test_shipping_validation` | - | asyncio, runtime | passed | 0.053 |
| `tests/runtime/test_catalog_api.py::test_variation_rules` | - | asyncio, runtime | passed | 0.088 |
...
| `tests/runtime/test_catalog_events.py::test_nip15_currency_mismatch_is_error` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_catalog_events.py::test_nip15_hidden_and_digital` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_catalog_events.py::test_nip15_projection` | - | asyncio, runtime | passed | 0.001 |
| `tests/runtime/test_catalog_events.py::test_nip15_variation_id_composition_and_fallback` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_catalog_events.py::test_outbox_dependency_edges` | - | asyncio, runtime | passed | 0.008 |
| `tests/runtime/test_catalog_events.py::test_outbox_enqueue_and_supersession` | - | asyncio, runtime | passed | 0.058 |
...
| `tests/runtime/test_catalog_events.py::test_tombstone_descriptor` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_checkout.py::test_fresh_checkout_creates_order` | - | asyncio, runtime | passed | 0.027 |
| `tests/runtime/test_checkout.py::test_fx_usd_conversion` | - | asyncio, runtime | passed | 0.025 |
| `tests/runtime/test_checkout.py::test_idempotency_crash_resume` | - | asyncio, runtime | passed | 0.030 |
| `tests/runtime/test_checkout.py::test_idempotency_replay_and_conflict` | - | asyncio, runtime | passed | 0.032 |
| `tests/runtime/test_checkout.py::test_intake_rejects_bad_items` | - | asyncio, runtime | passed | 1.429 |
...
| `tests/runtime/test_crypto_keystore.py::test_keystore_generate_sign_roundtrip` | - | asyncio, runtime | passed | 0.061 |
...
| `tests/runtime/test_crypto_keystore.py::test_keystore_rewrap_resume_drill` | - | asyncio, runtime | passed | 0.024 |
...
| `tests/runtime/test_db.py::test_commit_persists` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_db.py::test_concurrent_writers_serialize` | - | asyncio, runtime | passed | 0.121 |
...
| `tests/runtime/test_email_queue.py::test_claim_token_fencing` | - | asyncio, runtime | passed | 0.031 |
| `tests/runtime/test_email_queue.py::test_consent_revocation_suppresses` | - | asyncio, runtime | passed | 0.032 |
| `tests/runtime/test_email_queue.py::test_enqueue_dedupes` | - | asyncio, runtime | passed | 1.366 |
| `tests/runtime/test_email_queue.py::test_orderless_test_send` | - | asyncio, runtime | passed | 0.019 |
| `tests/runtime/test_email_queue.py::test_send_classification` | - | asyncio, runtime | passed | 0.059 |
| `tests/runtime/test_email_queue.py::test_subject_has_no_pii` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_email_queue.py::test_suppression_taxonomy` | - | asyncio, runtime | passed | 0.031 |
| `tests/runtime/test_install.py::test_admin_page_renders_template` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_install.py::test_admin_page_requires_auth` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_deactivation_404s_routes` | - | asyncio, runtime | passed | 0.046 |
| `tests/runtime/test_install.py::test_discovered_and_registered` | - | asyncio, runtime | passed | 1.274 |
| `tests/runtime/test_install.py::test_m001_tables_created` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_modeled_columns_match_registry` | - | asyncio, runtime | passed | 0.019 |
| `tests/runtime/test_install.py::test_reactivation_reruns_start_hook` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_install.py::test_static_probe_mounted` | - | asyncio, runtime | passed | 0.003 |
| `tests/runtime/test_merchant_api.py::test_audit_posture_qualified_and_flagged` | - | asyncio, runtime | passed | 0.117 |
| `tests/runtime/test_merchant_api.py::test_bearer_mutation_passes_without_origin` | - | asyncio, runtime | passed | 0.013 |
| `tests/runtime/test_merchant_api.py::test_cookie_mutation_requires_origin_and_csrf` | - | asyncio, runtime | passed | 0.018 |
| `tests/runtime/test_merchant_api.py::test_cookie_with_forged_bearer_still_enforces_origin` | - | asyncio, runtime | passed | 0.011 |
| `tests/runtime/test_merchant_api.py::test_current_merchant_projection` | - | asyncio, runtime | passed | 0.009 |
| `tests/runtime/test_merchant_api.py::test_deactivation_enqueues_tombstones` | - | asyncio, runtime | passed | 0.016 |
| `tests/runtime/test_merchant_api.py::test_duplicate_merchant_rejected` | - | asyncio, runtime | passed | 0.006 |
| `tests/runtime/test_merchant_api.py::test_foreign_merchant_is_404` | - | asyncio, runtime | passed | 0.006 |
| `tests/runtime/test_merchant_api.py::test_idempotency_key_accepted_and_shape_validated` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_merchant_api.py::test_key_import_replaces_identity` | - | asyncio, runtime | passed | 0.011 |
| `tests/runtime/test_merchant_api.py::test_notification_config` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_merchant_api.py::test_publish_enqueues_outbox_intents` | - | asyncio, runtime | passed | 0.017 |
| `tests/runtime/test_merchant_api.py::test_relay_config_validation` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_merchant_api.py::test_safe_get_requires_auth` | - | asyncio, runtime | passed | 1.290 |
| `tests/runtime/test_merchant_api.py::test_user_id_only_mutation_rejected` | - | asyncio, runtime | passed | 0.003 |
| `tests/runtime/test_merchant_api.py::test_wallet_binding_rejects_foreign_wallet` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_nip89.py::test_invalid_naddr_variants_render_invalid_link` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_nip89.py::test_public_product_json_contract` | - | asyncio, runtime | passed | 0.047 |
| `tests/runtime/test_nip89.py::test_public_product_page_states` | - | asyncio, runtime | passed | 0.123 |
| `tests/runtime/test_nip89.py::test_rate_limit_enforced_on_public_routes` | - | asyncio, runtime | passed | 0.591 |
| `tests/runtime/test_nip89.py::test_valid_naddr_redirects_to_canonical` | - | asyncio, runtime | passed | 1.355 |
| `tests/runtime/test_order_admin.py::test_admin_idempotency_key_accepted` | - | asyncio, runtime | passed | 0.158 |
| `tests/runtime/test_order_admin.py::test_cancel_releases_stock_once` | - | asyncio, runtime | passed | 0.065 |
| `tests/runtime/test_order_admin.py::test_decrypted_pii_owner_only` | - | asyncio, runtime | passed | 0.507 |
| `tests/runtime/test_order_admin.py::test_events_chronology` | - | asyncio, runtime | passed | 0.060 |
| `tests/runtime/test_order_admin.py::test_exception_refund_attestation` | - | asyncio, runtime | passed | 0.075 |
| `tests/runtime/test_order_admin.py::test_list_and_detail` | - | asyncio, runtime | passed | 1.376 |
| `tests/runtime/test_order_admin.py::test_token_reissue` | - | asyncio, runtime | passed | 0.060 |
| `tests/runtime/test_order_admin.py::test_transition_matrix` | - | asyncio, runtime | passed | 0.080 |
| `tests/runtime/test_order_saga.py::test_amount_and_wallet_mismatch_quarantine` | - | asyncio, runtime | passed | 0.104 |
| `tests/runtime/test_order_saga.py::test_buyer_cancel_before_payment` | - | asyncio, runtime | passed | 0.052 |
| `tests/runtime/test_order_saga.py::test_invoice_creation_unknown_never_duplicates` | - | asyncio, runtime | passed | 0.058 |
| `tests/runtime/test_order_saga.py::test_kill_before_callback_reconcile_confirms` | - | asyncio, runtime | passed | 0.073 |
| `tests/runtime/test_order_saga.py::test_late_settlement_on_expired_order` | - | asyncio, runtime | passed | 0.057 |
| `tests/runtime/test_order_saga.py::test_lease_fencing` | - | asyncio, runtime | passed | 0.106 |
| `tests/runtime/test_order_saga.py::test_reconcile_resumes_received_order` | - | asyncio, runtime | passed | 0.067 |
| `tests/runtime/test_order_saga.py::test_reservation_expiry_releases_once` | - | asyncio, runtime | passed | 0.055 |
| `tests/runtime/test_order_saga.py::test_settlement_confirms_once` | - | asyncio, runtime | passed | 1.391 |
| `tests/runtime/test_order_saga.py::test_settlement_foreign_payment_ignored` | - | asyncio, runtime | passed | 0.047 |
| `tests/runtime/test_outbox.py::test_accepted_targets_are_never_resent` | - | asyncio, runtime | passed | 20.110 |
| `tests/runtime/test_outbox.py::test_dead_relay_isolated_one_failure_never_crashes_batch` | - | asyncio, runtime | passed | 10.094 |
| `tests/runtime/test_outbox.py::test_dependency_gate_blocks_until_published` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_outbox.py::test_newer_live_revision_supersedes_stale_intent` | - | asyncio, runtime | passed | 0.040 |
...
| `tests/runtime/test_outbox.py::test_publish_accepted_marks_published_and_records_evidence` | - | asyncio, runtime | passed | 0.075 |
| `tests/runtime/test_outbox.py::test_rejected_and_timeout_relays_leave_intent_pending` | - | asyncio, runtime | passed | 10.038 |
| `tests/runtime/test_outbox.py::test_relay_targets_direction_and_defaults` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_outbox.py::test_retry_intent_resets_failed_and_skips_accepted` | - | asyncio, runtime | passed | 0.015 |
| `tests/runtime/test_outbox.py::test_stale_claim_recovery_requeues_with_evidence` | - | asyncio, runtime | passed | 0.011 |
| `tests/runtime/test_public_contract.py::test_checkout_rate_limits` | - | asyncio, runtime | passed | 0.083 |
| `tests/runtime/test_public_contract.py::test_end_to_end_journey` | - | asyncio, runtime | passed | 0.204 |
| `tests/runtime/test_public_contract.py::test_order_status_exact_field_set` | - | asyncio, runtime | passed | 0.055 |
| `tests/runtime/test_public_contract.py::test_protective_headers_everywhere` | - | asyncio, runtime | passed | 0.024 |
| `tests/runtime/test_public_contract.py::test_route_table_has_no_token_param` | - | asyncio, runtime | passed | 1.611 |
| `tests/runtime/test_public_contract.py::test_token_failures_indistinguishable` | - | asyncio, runtime | passed | 0.017 |
| `tests/runtime/test_public_pages.py::test_collection_and_merchant_pages` | - | asyncio, runtime | passed | 0.134 |
| `tests/runtime/test_public_pages.py::test_compact_fallback_and_gm_public_css` | - | asyncio, runtime | passed | 0.008 |
| `tests/runtime/test_public_pages.py::test_hidden_and_sold_and_preorder_states` | - | asyncio, runtime | passed | 0.161 |
| `tests/runtime/test_public_pages.py::test_not_found_and_invalid_d_tag` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_public_pages.py::test_order_page_shell` | - | asyncio, runtime | passed | 0.109 |
| `tests/runtime/test_public_pages.py::test_product_page_headers_and_scoping` | - | asyncio, runtime | passed | 1.671 |
| `tests/runtime/test_relay_config_api.py::test_blossom_servers_configurable_with_https_only` | - | asyncio, runtime | passed | 0.051 |
| `tests/runtime/test_relay_config_api.py::test_outbox_listing_and_retry_routes` | - | asyncio, runtime | passed | 0.165 |
| `tests/runtime/test_relay_config_api.py::test_relay_config_accepts_public_inbox_both` | - | asyncio, runtime | passed | 1.494 |
| `tests/runtime/test_relay_config_api.py::test_relay_config_rejects_invalid_and_duplicates` | - | asyncio, runtime | passed | 0.055 |
| `tests/runtime/test_release_a_journey.py::test_release_a_journey` | - | asyncio, runtime | passed | 1.942 |
| `tests/runtime/test_status_api.py::test_checkout_gated_by_readiness` | - | asyncio, runtime | passed | 0.107 |
| `tests/runtime/test_status_api.py::test_checkout_happy_path` | - | asyncio, runtime | passed | 0.060 |
| `tests/runtime/test_status_api.py::test_checkout_requires_idempotency_key` | - | asyncio, runtime | passed | 1.545 |
| `tests/runtime/test_status_api.py::test_email_opt_out` | - | asyncio, runtime | passed | 0.014 |
| `tests/runtime/test_status_api.py::test_order_status_after_confirmation` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_status_api.py::test_order_status_token_contract` | - | asyncio, runtime | passed | 0.017 |
| `tests/runtime/test_themes.py::test_advanced_token_allowlist` | - | asyncio, runtime | passed | 0.054 |
| `tests/runtime/test_themes.py::test_advanced_tokens_require_opt_in` | - | asyncio, runtime | passed | 0.025 |
| `tests/runtime/test_themes.py::test_brand_basics_bounds` | - | asyncio, runtime | passed | 0.115 |
| `tests/runtime/test_themes.py::test_contrast_gate_blocks_failing_pairs` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_themes.py::test_invalid_preset_and_layout_rejected` | - | asyncio, runtime | passed | 0.029 |
| `tests/runtime/test_themes.py::test_layout_compact_fallback_in_css` | - | asyncio, runtime | passed | 0.003 |
| `tests/runtime/test_themes.py::test_preset_and_layout_persist` | - | asyncio, runtime | passed | 1.450 |
| `tests/runtime/test_themes.py::test_reset_to_preset_clears_overrides` | - | asyncio, runtime | passed | 0.141 |
| `tests/runtime/test_themes.py::test_theme_reaches_public_page_only` | - | asyncio, runtime | passed | 0.219 |
