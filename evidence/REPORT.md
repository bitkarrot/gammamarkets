...
- Generated (UTC): 2026-09-22T06:52:45.473732+00:00
...
- Result: 332/333 passed (0 failed, 0 errors, 1 skipped), exit status 0
...
| --- | --- | --- | --- | --- |
| `tests/qualification/test_p0_01_pins.py::test_evidence_pins_block_matches_recorded_values` | P0-01 | fast | passed | 0.136 |
| `tests/qualification/test_p0_01_pins.py::test_harness_lock_wheel_parity_with_host_lock` | P0-01 | fast | passed | 0.049 |
| `tests/qualification/test_p0_01_pins.py::test_host_checkout_head_is_pinned_commit` | P0-01 | fast | passed | 0.064 |
...
| `tests/qualification/test_p0_01_pins.py::test_release_source_and_native_cargo_provenance` | P0-01 | fast | passed | 0.052 |
...
| `tests/qualification/test_p0_02_sdk_security.py::test_oversized_nip44_input_rejected_with_bounded_cost` | P0-02 | asyncio, sdk | passed | 2.690 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tampered_event_fails_verification` | P0-02 | asyncio, sdk | passed | 0.001 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tested_binary_identity_recorded_into_evidence_pins` | P0-02 | asyncio, sdk | passed | 0.042 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_listener_lifecycle_and_owned_handle_cancellation` | P0-03 | asyncio, host | passed | 2.515 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_metadata_persisted_and_exactly_queryable` | P0-03 | asyncio, host | passed | 1.192 |
| `tests/qualification/test_p0_03_host_contract.py::test_no_durable_callback_delivery_across_restart` | P0-03 | asyncio, host | passed | 5.381 |
| `tests/qualification/test_p0_04_relay_ack.py::test_external_relay_smoke` | P0-04 | asyncio, protocol, skipif | skipped | 0.007 |
| `tests/qualification/test_p0_04_relay_ack.py::test_positive_negative_and_timeout_acks_classified_per_relay` | P0-04 | asyncio, protocol | passed | 10.042 |
| `tests/qualification/test_p0_04_relay_ack.py::test_targeted_send_never_reaches_unlisted_relay` | P0-04 | asyncio, protocol | passed | 0.016 |
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_copies_route_only_to_their_partys_relays` | P0-05 | asyncio, protocol | passed | 0.004 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_golden_recipient_copy_unwraps_to_golden_rumor` | P0-05 | asyncio, protocol | passed | 0.012 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_no_plaintext_or_key_material_in_logs` | P0-05 | asyncio, protocol | passed | 0.016 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_seal_with_nonempty_tags_rejected` | P0-05 | asyncio, protocol | passed | 0.006 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_valid_wrap_with_undecryptable_content_rejected` | P0-05 | asyncio, protocol | passed | 0.007 |
...
| `tests/qualification/test_p0_06_transactions.py::test_adapter_only_transaction_rolls_back_cleanly` | P0-06 | asyncio, db | passed | 0.016 |
| `tests/qualification/test_p0_06_transactions.py::test_adapter_performs_in_transaction_writes_without_host_helpers` | P0-06 | asyncio, db | passed | 0.018 |
| `tests/qualification/test_p0_06_transactions.py::test_concurrent_duplicate_scoped_order_inserts_yield_one_row` | P0-06 | asyncio, db | passed | 0.013 |
| `tests/qualification/test_p0_06_transactions.py::test_dialect_selection_matches_environment` | P0-06 | db | passed | 0.000 |
| `tests/qualification/test_p0_06_transactions.py::test_duplicate_scoped_order_insert_conflicts` | P0-06 | asyncio, db | passed | 0.013 |
| `tests/qualification/test_p0_06_transactions.py::test_guard_failure_mid_claim_rolls_back_everything` | P0-06 | asyncio, db | passed | 0.027 |
| `tests/qualification/test_p0_06_transactions.py::test_host_auto_commit_helper_splits_domain_transaction` | P0-06 | asyncio, db | passed | 0.018 |
| `tests/qualification/test_p0_06_transactions.py::test_idempotency_record_scope_conflict` | P0-06 | asyncio, db | passed | 0.023 |
| `tests/qualification/test_p0_06_transactions.py::test_last_unit_concurrency_yields_exactly_one_reservation` | P0-06 | asyncio, db | passed | 0.057 |
| `tests/qualification/test_p0_06_transactions.py::test_lost_cas_rolls_back_the_entire_transaction` | P0-06 | asyncio, db | passed | 0.019 |
| `tests/qualification/test_p0_06_transactions.py::test_order_state_machine_table_exhaustive` | P0-06 | asyncio, db | passed | 0.232 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[inventory_reservations-params0]` | P0-06 | asyncio, db, parametrize | passed | 0.017 |
...
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[order_items-params2]` | P0-06 | asyncio, db, parametrize | passed | 0.015 |
...
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[relay_publications-params4]` | P0-06 | asyncio, db, parametrize | passed | 0.014 |
| `tests/qualification/test_p0_06_transactions.py::test_sorted_id_locking_avoids_deadlock` | P0-06 | asyncio, db | passed | 0.400 |
| `tests/qualification/test_p0_06_transactions.py::test_task_lease_fencing_rejects_stale_writes` | P0-06 | asyncio, db | passed | 0.020 |
| `tests/qualification/test_p0_06_transactions.py::test_winning_cas_leaves_one_held_reservation` | P0-06 | asyncio, db | passed | 0.028 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_during_inflight_invoice_creation[rejected]` | P0-07 | asyncio, db, parametrize | passed | 0.025 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_during_inflight_invoice_creation[success]` | P0-07 | asyncio, db, parametrize | passed | 0.029 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_during_inflight_invoice_creation[unknown]` | P0-07 | asyncio, db, parametrize | passed | 0.022 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_awaiting_payment_then_late_settlement` | P0-07 | asyncio, db | passed | 0.080 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[unknown]` | P0-07 | asyncio, db, parametrize | passed | 0.022 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_creation_unknown_reconciliation_attaches_exactly_one` | P0-07 | asyncio, db | passed | 0.046 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_multiple_core_payments_with_one_external_id_quarantines` | P0-07 | asyncio, db | passed | 0.028 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_zero_matches_after_window_fails_projection_only_for_invoice_pending` | P0-07 | asyncio, db | passed | 0.086 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_claim_respects_dependencies_and_supersede` | P0-08 | asyncio, db | passed | 0.032 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_lease_expired_mid_claim_requeues_and_reclaims` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_merchant_sender_copy_recovered_without_dispatch` | P0-08 | asyncio, db | passed | 0.025 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_pre_reservation_crash_resume_is_idempotent` | P0-08 | asyncio, db | passed | 0.024 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_relay_cursors_advance_only_after_eose` | P0-08 | asyncio, db | passed | 0.019 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_admitted_not_validated` | P0-08 | asyncio, db | passed | 0.017 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_attach_before_enqueue` | P0-08 | asyncio, db | passed | 0.025 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_invoice_before_attach` | P0-08 | asyncio, db | passed | 0.025 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_reservation_before_invoice_call` | P0-08 | asyncio, db | passed | 0.034 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_partially_published_retries_only_missing` | P0-08 | asyncio, db | passed | 0.026 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_validated_not_dispatched` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_zero_positive_oks_backoff_then_failed` | P0-08 | asyncio, db | passed | 0.030 |
| `tests/qualification/test_p0_09_email_persistence.py::test_equality_hashes_are_purpose_separated_and_irreversible` | P0-09 | asyncio, db | passed | 0.028 |
| `tests/qualification/test_p0_09_email_persistence.py::test_malformed_and_noncanonical_tokens_rejected_before_lookup` | P0-09 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_09_email_persistence.py::test_no_plaintext_recipients_or_tokens_in_database` | P0-09 | asyncio, db | passed | 0.047 |
| `tests/qualification/test_p0_09_email_persistence.py::test_opt_out_revokes_consent_and_cancels_queued_customer_rows` | P0-09 | asyncio, db | passed | 0.044 |
| `tests/qualification/test_p0_09_email_persistence.py::test_token_rotation_and_revocation_invalidate_immediately` | P0-09 | asyncio, db | passed | 0.043 |
| `tests/qualification/test_p0_09_email_persistence.py::test_token_survives_idempotency_retention_then_expires` | P0-09 | asyncio, db | passed | 0.041 |
| `tests/qualification/test_p0_09_email_persistence.py::test_two_merchant_recipients_two_rows_delivered_independently` | P0-09 | asyncio, db | passed | 0.084 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_crash_after_smtp_acceptance_redelivers_on_resume` | P0-10 | asyncio, db | passed | 0.029 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_customer_rate_limit_waits_rather_than_delivering` | P0-10 | asyncio, db | passed | 0.066 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_exhausted_attempts_enter_failed_never_sent` | P0-10 | asyncio, db | passed | 0.031 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_logs_expose_neither_recipients_nor_bearer_links` | P0-10 | asyncio, db | passed | 0.030 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_merchant_alert_rate_limit_at_60_per_hour` | P0-10 | asyncio, db | passed | 0.215 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_only_true_enters_sent_false_retries_with_bound` | P0-10 | asyncio, db | passed | 0.029 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_raised_exception_and_recipient_rejection_surface_identically` | P0-10 | asyncio, db | passed | 0.025 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_suppressed_rows_never_touch_smtp` | P0-10 | asyncio, db | passed | 0.047 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_true_enters_sent_with_sent_at` | P0-10 | asyncio, db | passed | 0.021 |
| `tests/qualification/test_p0_11_nip89_route.py::test_foreign_merchant_naddr_rejected` | P0-11 | protocol | passed | 0.000 |
| `tests/qualification/test_p0_11_nip89_route.py::test_golden_naddr_resolves_locally` | P0-11 | protocol | passed | 0.003 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_invalid_product_variants_rejected[invalid_quantity_string.json-product-quantity-not-int-or-null]` | P0-11 | parametrize, protocol | passed | 0.002 |
| `tests/qualification/test_p0_11_nip89_route.py::test_invalid_product_variants_rejected[invalid_specs_object.json-product-specs-not-pair-array]` | P0-11 | parametrize, protocol | passed | 0.005 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_opaque_address_physical_order_shape` | P0-11 | protocol | passed | 0.002 |
...
| `tests/qualification/test_p0_11_nip89_route.py::test_valid_stall_and_product_dtos` | P0-11 | protocol | passed | 0.008 |
| `tests/qualification/test_p0_11_nip89_route.py::test_wrong_kind_naddr_rejected` | P0-11 | protocol | passed | 0.000 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_approved_cookie_same_origin_path_passes` | P0-12 | asyncio, host | passed | 0.239 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cookie_only_without_origin_rejected` | P0-12 | asyncio, host | passed | 0.246 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cross_origin_cookie_mutation_rejected` | P0-12 | asyncio, host | passed | 0.238 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_id_only_login_method_refused` | P0-12 | asyncio, host | passed | 1.001 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_mutation_requires_authenticated_session` | P0-12 | asyncio, host | passed | 0.003 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_order_status_requires_x_order_token_header` | P0-12 | asyncio, host | passed | 0.002 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_order_status_token_in_query_rejected` | P0-12 | asyncio, host | passed | 0.002 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[-1-False-unsupported-dialect:unknown]` | P0-12 | asyncio, host, parametrize | passed | 0.105 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[postgresql-1-True-supported]` | P0-12 | asyncio, host, parametrize | passed | 0.002 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[postgresql-4-True-supported]` | P0-12 | asyncio, host, parametrize | passed | 0.002 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[sqlite-1-True-supported]` | P0-12 | asyncio, host, parametrize | passed | 0.003 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[sqlite-2-False-sqlite-multi-process-refused]` | P0-12 | asyncio, host, parametrize | passed | 0.002 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_production_topology_refusal[sqlite-8-False-sqlite-multi-process-refused]` | P0-12 | asyncio, host, parametrize | passed | 0.002 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_sdk_client_cleanup_on_direct_task_cancel` | P0-12 | asyncio, host | passed | 0.156 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_startup_registers_only_bounded_tasks` | P0-12 | asyncio, host | passed | 0.052 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_stop_hook_cancels_only_owned_handles` | P0-12 | asyncio, host | passed | 0.104 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_wrong_origin_subdomain_rejected` | P0-12 | asyncio, host | passed | 0.250 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_all_providers_failed_rejects_no_provenance` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_ceiling_applies_per_component_not_on_summed_total` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_checked_total_sum_and_minimum_one_sat` | P0-13 | db | passed | 0.000 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_empty_quote_rejected` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_failed_nonfinite_nonpositive_providers_filtered` | P0-13 | db | passed | 0.002 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_fractional_minor_unit_conversion_ceils` | P0-13 | db | passed | 0.005 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_model_never_calls_host_cached_fiat_helper` | P0-13 | db | passed | 0.010 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_nonfinite_rate_rejected` | P0-13 | db | passed | 0.002 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_order_fx_quotes_persists_decimal_strings` | P0-13 | asyncio, db | passed | 0.026 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_order_fx_quotes_unique_per_currency` | P0-13 | asyncio, db | passed | 0.017 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_provenance_free_quote_rejected` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_provider_floats_cross_once_via_decimal_str` | P0-13 | db | passed | 0.002 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_quote_ttl_is_five_minutes` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_rejection_leaves_no_reservation_or_stock_or_quote_rows` | P0-13 | asyncio, db | passed | 0.016 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_stale_quote_rejected_at_conversion_edge` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_valid_quote_then_reservation_flow` | P0-13 | asyncio, db | passed | 0.013 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_zero_and_negative_rate_rejected` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_14_contract_closure.py::test_fixture_coverage_for_required_kinds` | P0-14 | protocol | passed | 0.002 |
| `tests/qualification/test_p0_14_contract_closure.py::test_identifier_closure` | P0-14 | protocol | passed | 0.012 |
...
| `tests/runtime/test_catalog_api.py::test_catalog_crud` | - | asyncio, runtime | passed | 1.379 |
| `tests/runtime/test_catalog_api.py::test_collection_zero_members_no_intent` | - | asyncio, runtime | passed | 0.014 |
| `tests/runtime/test_catalog_api.py::test_delete_reference_report_and_strip` | - | asyncio, runtime | passed | 0.024 |
| `tests/runtime/test_catalog_api.py::test_draft_produces_no_intent` | - | asyncio, runtime | passed | 0.021 |
| `tests/runtime/test_catalog_api.py::test_dry_run_deterministic` | - | asyncio, runtime | passed | 0.025 |
| `tests/runtime/test_catalog_api.py::test_membership_enqueues_collection_and_product_dep` | - | asyncio, runtime | passed | 0.024 |
| `tests/runtime/test_catalog_api.py::test_owner_scoping` | - | asyncio, runtime | passed | 0.592 |
| `tests/runtime/test_catalog_api.py::test_product_crud_and_outbox_intent` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_catalog_api.py::test_product_delete_enqueues_tombstone` | - | asyncio, runtime | passed | 0.019 |
| `tests/runtime/test_catalog_api.py::test_product_validation_bounds` | - | asyncio, runtime | passed | 0.098 |
| `tests/runtime/test_catalog_api.py::test_published_at_preserved_across_edits` | - | asyncio, runtime | passed | 0.036 |
| `tests/runtime/test_catalog_api.py::test_shipping_validation` | - | asyncio, runtime | passed | 0.047 |
| `tests/runtime/test_catalog_api.py::test_variation_rules` | - | asyncio, runtime | passed | 0.078 |
| `tests/runtime/test_catalog_events.py::test_collection_event` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_catalog_events.py::test_identity_and_handler_events_have_no_labels` | - | asyncio, runtime | passed | 0.000 |
...
| `tests/runtime/test_catalog_events.py::test_outbox_dependency_edges` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_catalog_events.py::test_outbox_enqueue_and_supersession` | - | asyncio, runtime | passed | 0.074 |
...
| `tests/runtime/test_catalog_events.py::test_product_event_unlimited_stock_omits_stock_tag` | - | asyncio, runtime | passed | 0.000 |
| `tests/runtime/test_catalog_events.py::test_product_event_variation_single_parent_a` | - | asyncio, runtime | passed | 0.000 |
...
| `tests/runtime/test_crypto_keystore.py::test_envelope_rejects_wrong_aad_parts` | - | runtime | passed | 0.000 |
...
| `tests/runtime/test_crypto_keystore.py::test_keyring_validation_via_env` | - | runtime | passed | 0.000 |
| `tests/runtime/test_crypto_keystore.py::test_keystore_backup_restore_drill` | - | asyncio, runtime | passed | 0.011 |
| `tests/runtime/test_crypto_keystore.py::test_keystore_generate_sign_roundtrip` | - | asyncio, runtime | passed | 0.062 |
...
| `tests/runtime/test_crypto_keystore.py::test_keystore_rewrap_resume_drill` | - | asyncio, runtime | passed | 0.033 |
| `tests/runtime/test_crypto_keystore.py::test_keystore_rewrap_rotation_drill` | - | asyncio, runtime | passed | 0.013 |
...
| `tests/runtime/test_db.py::test_commit_persists` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_db.py::test_concurrent_writers_serialize` | - | asyncio, runtime | passed | 0.117 |
| `tests/runtime/test_db.py::test_fencing_update_inside_tx` | - | asyncio, runtime | passed | 0.004 |
| `tests/runtime/test_db.py::test_fk_enforced_inside_tx` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_db.py::test_rollback_discards` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_admin_page_renders_template` | - | asyncio, runtime | passed | 0.125 |
| `tests/runtime/test_install.py::test_admin_page_requires_auth` | - | asyncio, runtime | passed | 0.003 |
| `tests/runtime/test_install.py::test_deactivation_404s_routes` | - | asyncio, runtime | passed | 0.054 |
| `tests/runtime/test_install.py::test_discovered_and_registered` | - | asyncio, runtime | passed | 1.414 |
| `tests/runtime/test_install.py::test_m001_tables_created` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_modeled_columns_match_registry` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_install.py::test_reactivation_reruns_start_hook` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_install.py::test_static_probe_mounted` | - | asyncio, runtime | passed | 0.006 |
| `tests/runtime/test_merchant_api.py::test_audit_posture_qualified_and_flagged` | - | asyncio, runtime | passed | 0.119 |
| `tests/runtime/test_merchant_api.py::test_bearer_mutation_passes_without_origin` | - | asyncio, runtime | passed | 0.012 |
| `tests/runtime/test_merchant_api.py::test_cookie_mutation_requires_origin_and_csrf` | - | asyncio, runtime | passed | 0.020 |
...
| `tests/runtime/test_merchant_api.py::test_deactivation_enqueues_tombstones` | - | asyncio, runtime | passed | 0.013 |
...
| `tests/runtime/test_merchant_api.py::test_idempotency_key_accepted_and_shape_validated` | - | asyncio, runtime | passed | 0.021 |
| `tests/runtime/test_merchant_api.py::test_key_import_replaces_identity` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_merchant_api.py::test_notification_config` | - | asyncio, runtime | passed | 0.017 |
| `tests/runtime/test_merchant_api.py::test_publish_enqueues_outbox_intents` | - | asyncio, runtime | passed | 0.016 |
| `tests/runtime/test_merchant_api.py::test_relay_config_validation` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_merchant_api.py::test_safe_get_requires_auth` | - | asyncio, runtime | passed | 1.351 |
| `tests/runtime/test_merchant_api.py::test_user_id_only_mutation_rejected` | - | asyncio, runtime | passed | 0.003 |
| `tests/runtime/test_merchant_api.py::test_wallet_binding_rejects_foreign_wallet` | - | asyncio, runtime | passed | 0.008 |
| `tests/runtime/test_nip89.py::test_invalid_naddr_variants_render_invalid_link` | - | asyncio, runtime | passed | 0.031 |
| `tests/runtime/test_nip89.py::test_public_product_json_contract` | - | asyncio, runtime | passed | 0.046 |
| `tests/runtime/test_nip89.py::test_public_product_page_states` | - | asyncio, runtime | passed | 0.118 |
| `tests/runtime/test_nip89.py::test_rate_limit_enforced_on_public_routes` | - | asyncio, runtime | passed | 0.607 |
| `tests/runtime/test_nip89.py::test_valid_naddr_redirects_to_canonical` | - | asyncio, runtime | passed | 1.315 |
| `tests/runtime/test_outbox.py::test_accepted_targets_are_never_resent` | - | asyncio, runtime | passed | 30.186 |
| `tests/runtime/test_outbox.py::test_dead_relay_isolated_one_failure_never_crashes_batch` | - | asyncio, runtime | passed | 9.078 |
| `tests/runtime/test_outbox.py::test_dependency_gate_blocks_until_published` | - | asyncio, runtime | passed | 0.036 |
| `tests/runtime/test_outbox.py::test_newer_live_revision_supersedes_stale_intent` | - | asyncio, runtime | passed | 8.083 |
...
| `tests/runtime/test_outbox.py::test_publish_accepted_marks_published_and_records_evidence` | - | asyncio, runtime | passed | 0.187 |
| `tests/runtime/test_outbox.py::test_rejected_and_timeout_relays_leave_intent_pending` | - | asyncio, runtime | passed | 10.064 |
| `tests/runtime/test_outbox.py::test_relay_targets_direction_and_defaults` | - | asyncio, runtime | passed | 0.029 |
| `tests/runtime/test_outbox.py::test_retry_intent_resets_failed_and_skips_accepted` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_outbox.py::test_stale_claim_recovery_requeues_with_evidence` | - | asyncio, runtime | passed | 0.012 |
| `tests/runtime/test_public_pages.py::test_collection_and_merchant_pages` | - | asyncio, runtime | passed | 0.090 |
| `tests/runtime/test_public_pages.py::test_compact_fallback_and_gm_public_css` | - | asyncio, runtime | passed | 0.004 |
| `tests/runtime/test_public_pages.py::test_hidden_and_sold_and_preorder_states` | - | asyncio, runtime | passed | 0.130 |
| `tests/runtime/test_public_pages.py::test_not_found_and_invalid_d_tag` | - | asyncio, runtime | passed | 0.014 |
| `tests/runtime/test_public_pages.py::test_order_page_shell` | - | asyncio, runtime | passed | 0.107 |
| `tests/runtime/test_public_pages.py::test_product_page_headers_and_scoping` | - | asyncio, runtime | passed | 1.527 |
| `tests/runtime/test_relay_config_api.py::test_blossom_servers_configurable_with_https_only` | - | asyncio, runtime | passed | 0.037 |
| `tests/runtime/test_relay_config_api.py::test_outbox_listing_and_retry_routes` | - | asyncio, runtime | passed | 0.144 |
| `tests/runtime/test_relay_config_api.py::test_relay_config_accepts_public_inbox_both` | - | asyncio, runtime | passed | 1.363 |
| `tests/runtime/test_relay_config_api.py::test_relay_config_rejects_invalid_and_duplicates` | - | asyncio, runtime | passed | 0.039 |
...
| `tests/runtime/test_themes.py::test_brand_basics_bounds` | - | asyncio, runtime | passed | 0.047 |
| `tests/runtime/test_themes.py::test_contrast_gate_blocks_failing_pairs` | - | asyncio, runtime | passed | 0.011 |
...
| `tests/runtime/test_themes.py::test_preset_and_layout_persist` | - | asyncio, runtime | passed | 1.418 |
| `tests/runtime/test_themes.py::test_reset_to_preset_clears_overrides` | - | asyncio, runtime | passed | 0.132 |
| `tests/runtime/test_themes.py::test_theme_reaches_public_page_only` | - | asyncio, runtime | passed | 0.196 |
