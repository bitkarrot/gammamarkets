...
- Generated (UTC): 2026-09-22T06:05:07.180683+00:00
...
- Result: 296/297 passed (0 failed, 0 errors, 1 skipped), exit status 0
...
| --- | --- | --- | --- | --- |
| `tests/qualification/test_p0_01_pins.py::test_evidence_pins_block_matches_recorded_values` | P0-01 | fast | passed | 0.139 |
| `tests/qualification/test_p0_01_pins.py::test_harness_lock_wheel_parity_with_host_lock` | P0-01 | fast | passed | 0.051 |
| `tests/qualification/test_p0_01_pins.py::test_host_checkout_head_is_pinned_commit` | P0-01 | fast | passed | 0.020 |
| `tests/qualification/test_p0_01_pins.py::test_host_lock_and_pypi_are_wheels_only` | P0-01 | fast | passed | 0.035 |
...
| `tests/qualification/test_p0_01_pins.py::test_release_source_and_native_cargo_provenance` | P0-01 | fast | passed | 0.054 |
...
| `tests/qualification/test_p0_02_sdk_security.py::test_oversized_nip44_input_rejected_with_bounded_cost` | P0-02 | asyncio, sdk | passed | 2.600 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tampered_event_fails_verification` | P0-02 | asyncio, sdk | passed | 0.001 |
| `tests/qualification/test_p0_02_sdk_security.py::test_tested_binary_identity_recorded_into_evidence_pins` | P0-02 | asyncio, sdk | passed | 0.051 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_listener_lifecycle_and_owned_handle_cancellation` | P0-03 | asyncio, host | passed | 2.343 |
| `tests/qualification/test_p0_03_host_contract.py::test_invoice_metadata_persisted_and_exactly_queryable` | P0-03 | asyncio, host | passed | 1.125 |
| `tests/qualification/test_p0_03_host_contract.py::test_no_durable_callback_delivery_across_restart` | P0-03 | asyncio, host | passed | 5.271 |
| `tests/qualification/test_p0_04_relay_ack.py::test_external_relay_smoke` | P0-04 | asyncio, protocol, skipif | skipped | 0.001 |
| `tests/qualification/test_p0_04_relay_ack.py::test_positive_negative_and_timeout_acks_classified_per_relay` | P0-04 | asyncio, protocol | passed | 10.032 |
| `tests/qualification/test_p0_04_relay_ack.py::test_targeted_send_never_reaches_unlisted_relay` | P0-04 | asyncio, protocol | passed | 0.017 |
...
| `tests/qualification/test_p0_05_encrypted_fixtures.py::test_golden_recipient_copy_unwraps_to_golden_rumor` | P0-05 | asyncio, protocol | passed | 0.010 |
...
| `tests/qualification/test_p0_06_transactions.py::test_duplicate_scoped_order_insert_conflicts` | P0-06 | asyncio, db | passed | 0.014 |
| `tests/qualification/test_p0_06_transactions.py::test_guard_failure_mid_claim_rolls_back_everything` | P0-06 | asyncio, db | passed | 0.036 |
...
| `tests/qualification/test_p0_06_transactions.py::test_last_unit_concurrency_yields_exactly_one_reservation` | P0-06 | asyncio, db | passed | 0.043 |
| `tests/qualification/test_p0_06_transactions.py::test_lost_cas_rolls_back_the_entire_transaction` | P0-06 | asyncio, db | passed | 0.013 |
| `tests/qualification/test_p0_06_transactions.py::test_order_state_machine_table_exhaustive` | P0-06 | asyncio, db | passed | 0.188 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[inventory_reservations-params0]` | P0-06 | asyncio, db, parametrize | passed | 0.012 |
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[inventory_reservations-params1]` | P0-06 | asyncio, db, parametrize | passed | 0.012 |
...
| `tests/qualification/test_p0_06_transactions.py::test_orphan_inserts_violate_foreign_keys[order_items-params3]` | P0-06 | asyncio, db, parametrize | passed | 0.011 |
...
| `tests/qualification/test_p0_06_transactions.py::test_sorted_id_locking_avoids_deadlock` | P0-06 | asyncio, db | passed | 0.387 |
| `tests/qualification/test_p0_06_transactions.py::test_task_lease_fencing_rejects_stale_writes` | P0-06 | asyncio, db | passed | 0.014 |
| `tests/qualification/test_p0_06_transactions.py::test_winning_cas_leaves_one_held_reservation` | P0-06 | asyncio, db | passed | 0.020 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_during_inflight_invoice_creation[success]` | P0-07 | asyncio, db, parametrize | passed | 0.022 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[rejected]` | P0-07 | asyncio, db, parametrize | passed | 0.018 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[success]` | P0-07 | asyncio, db, parametrize | passed | 0.021 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_cancel_from_received_never_creates_an_invoice[unknown]` | P0-07 | asyncio, db, parametrize | passed | 0.019 |
...
| `tests/qualification/test_p0_07_cancellation_saga.py::test_multiple_core_payments_with_one_external_id_quarantines` | P0-07 | asyncio, db | passed | 0.019 |
| `tests/qualification/test_p0_07_cancellation_saga.py::test_zero_matches_after_window_fails_projection_only_for_invoice_pending` | P0-07 | asyncio, db | passed | 0.028 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_order_msg_keeps_stable_rumor_id_across_retries` | P0-08 | asyncio, db | passed | 0.021 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_pre_reservation_crash_resume_is_idempotent` | P0-08 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_relay_cursors_advance_only_after_eose` | P0-08 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_admitted_not_validated` | P0-08 | asyncio, db | passed | 0.016 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_after_reservation_before_invoice_call` | P0-08 | asyncio, db | passed | 0.020 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_between_settlement_and_callback` | P0-08 | asyncio, db | passed | 0.026 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_claimed_not_published` | P0-08 | asyncio, db | passed | 0.023 |
...
| `tests/qualification/test_p0_08_recovery_closure.py::test_restart_validated_not_dispatched` | P0-08 | asyncio, db | passed | 0.015 |
| `tests/qualification/test_p0_08_recovery_closure.py::test_zero_positive_oks_backoff_then_failed` | P0-08 | asyncio, db | passed | 0.028 |
| `tests/qualification/test_p0_09_email_persistence.py::test_equality_hashes_are_purpose_separated_and_irreversible` | P0-09 | asyncio, db | passed | 0.014 |
| `tests/qualification/test_p0_09_email_persistence.py::test_malformed_and_noncanonical_tokens_rejected_before_lookup` | P0-09 | asyncio, db | passed | 0.011 |
| `tests/qualification/test_p0_09_email_persistence.py::test_no_plaintext_recipients_or_tokens_in_database` | P0-09 | asyncio, db | passed | 0.023 |
...
| `tests/qualification/test_p0_09_email_persistence.py::test_token_rotation_and_revocation_invalidate_immediately` | P0-09 | asyncio, db | passed | 0.017 |
| `tests/qualification/test_p0_09_email_persistence.py::test_token_survives_idempotency_retention_then_expires` | P0-09 | asyncio, db | passed | 0.017 |
...
| `tests/qualification/test_p0_10_smtp_boundary.py::test_crash_after_smtp_acceptance_redelivers_on_resume` | P0-10 | asyncio, db | passed | 0.019 |
...
| `tests/qualification/test_p0_10_smtp_boundary.py::test_exhausted_attempts_enter_failed_never_sent` | P0-10 | asyncio, db | passed | 0.027 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_logs_expose_neither_recipients_nor_bearer_links` | P0-10 | asyncio, db | passed | 0.024 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_merchant_alert_rate_limit_at_60_per_hour` | P0-10 | asyncio, db | passed | 0.160 |
...
| `tests/qualification/test_p0_10_smtp_boundary.py::test_raised_exception_and_recipient_rejection_surface_identically` | P0-10 | asyncio, db | passed | 0.022 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_suppressed_rows_never_touch_smtp` | P0-10 | asyncio, db | passed | 0.037 |
| `tests/qualification/test_p0_10_smtp_boundary.py::test_true_enters_sent_with_sent_at` | P0-10 | asyncio, db | passed | 0.014 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_approved_cookie_same_origin_path_passes` | P0-12 | asyncio, host | passed | 0.217 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cookie_only_without_origin_rejected` | P0-12 | asyncio, host | passed | 0.223 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_cross_origin_cookie_mutation_rejected` | P0-12 | asyncio, host | passed | 0.293 |
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_id_only_login_method_refused` | P0-12 | asyncio, host | passed | 0.630 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_startup_registers_only_bounded_tasks` | P0-12 | asyncio, host | passed | 0.050 |
...
| `tests/qualification/test_p0_12_auth_privacy_lifecycle.py::test_wrong_origin_subdomain_rejected` | P0-12 | asyncio, host | passed | 0.235 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_model_never_calls_host_cached_fiat_helper` | P0-13 | db | passed | 0.007 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_provider_floats_cross_once_via_decimal_str` | P0-13 | db | passed | 0.003 |
...
| `tests/qualification/test_p0_13_decimal_fx.py::test_valid_quote_then_reservation_flow` | P0-13 | asyncio, db | passed | 0.012 |
| `tests/qualification/test_p0_13_decimal_fx.py::test_zero_and_negative_rate_rejected` | P0-13 | db | passed | 0.001 |
| `tests/qualification/test_p0_14_contract_closure.py::test_fixture_coverage_for_required_kinds` | P0-14 | protocol | passed | 0.000 |
...
| `tests/qualification/test_p0_14_contract_closure.py::test_schema_fields_match_registry_bidirectional` | P0-14 | protocol | passed | 0.004 |
...
| `tests/runtime/test_catalog_api.py::test_catalog_crud` | - | asyncio, runtime | passed | 1.162 |
| `tests/runtime/test_catalog_api.py::test_collection_zero_members_no_intent` | - | asyncio, runtime | passed | 0.015 |
| `tests/runtime/test_catalog_api.py::test_delete_reference_report_and_strip` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_catalog_api.py::test_draft_produces_no_intent` | - | asyncio, runtime | passed | 0.020 |
| `tests/runtime/test_catalog_api.py::test_dry_run_deterministic` | - | asyncio, runtime | passed | 0.023 |
| `tests/runtime/test_catalog_api.py::test_membership_enqueues_collection_and_product_dep` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_catalog_api.py::test_owner_scoping` | - | asyncio, runtime | passed | 0.550 |
| `tests/runtime/test_catalog_api.py::test_product_crud_and_outbox_intent` | - | asyncio, runtime | passed | 0.021 |
| `tests/runtime/test_catalog_api.py::test_product_delete_enqueues_tombstone` | - | asyncio, runtime | passed | 0.019 |
| `tests/runtime/test_catalog_api.py::test_product_validation_bounds` | - | asyncio, runtime | passed | 0.089 |
| `tests/runtime/test_catalog_api.py::test_published_at_preserved_across_edits` | - | asyncio, runtime | passed | 0.034 |
| `tests/runtime/test_catalog_api.py::test_shipping_validation` | - | asyncio, runtime | passed | 0.045 |
| `tests/runtime/test_catalog_api.py::test_variation_rules` | - | asyncio, runtime | passed | 0.076 |
...
| `tests/runtime/test_catalog_events.py::test_outbox_enqueue_and_supersession` | - | asyncio, runtime | passed | 0.046 |
...
| `tests/runtime/test_crypto_keystore.py::test_keystore_backup_restore_drill` | - | asyncio, runtime | passed | 0.009 |
| `tests/runtime/test_crypto_keystore.py::test_keystore_generate_sign_roundtrip` | - | asyncio, runtime | passed | 0.041 |
...
| `tests/runtime/test_crypto_keystore.py::test_keystore_rewrap_resume_drill` | - | asyncio, runtime | passed | 0.022 |
| `tests/runtime/test_crypto_keystore.py::test_keystore_rewrap_rotation_drill` | - | asyncio, runtime | passed | 0.009 |
...
| `tests/runtime/test_db.py::test_commit_persists` | - | asyncio, runtime | passed | 0.016 |
...
| `tests/runtime/test_install.py::test_admin_page_renders_template` | - | asyncio, runtime | passed | 0.106 |
| `tests/runtime/test_install.py::test_admin_page_requires_auth` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_deactivation_404s_routes` | - | asyncio, runtime | passed | 0.032 |
| `tests/runtime/test_install.py::test_discovered_and_registered` | - | asyncio, runtime | passed | 1.177 |
| `tests/runtime/test_install.py::test_m001_tables_created` | - | asyncio, runtime | passed | 0.002 |
| `tests/runtime/test_install.py::test_modeled_columns_match_registry` | - | asyncio, runtime | passed | 0.006 |
| `tests/runtime/test_install.py::test_reactivation_reruns_start_hook` | - | asyncio, runtime | passed | 0.102 |
| `tests/runtime/test_install.py::test_static_probe_mounted` | - | asyncio, runtime | passed | 0.005 |
| `tests/runtime/test_merchant_api.py::test_audit_posture_qualified_and_flagged` | - | asyncio, runtime | passed | 0.115 |
...
| `tests/runtime/test_merchant_api.py::test_cookie_with_forged_bearer_still_enforces_origin` | - | asyncio, runtime | passed | 0.010 |
| `tests/runtime/test_merchant_api.py::test_current_merchant_projection` | - | asyncio, runtime | passed | 0.008 |
...
| `tests/runtime/test_merchant_api.py::test_notification_config` | - | asyncio, runtime | passed | 0.018 |
| `tests/runtime/test_merchant_api.py::test_publish_enqueues_outbox_intents` | - | asyncio, runtime | passed | 0.014 |
| `tests/runtime/test_merchant_api.py::test_relay_config_validation` | - | asyncio, runtime | passed | 0.018 |
| `tests/runtime/test_merchant_api.py::test_safe_get_requires_auth` | - | asyncio, runtime | passed | 1.199 |
